...
<div class="d-flex justify-content-around mt-3 flex-wrap">
    <a  href="buy_3alaf_add.php"  class="btn btn-success pb-1 pt-1" >
...
<table id="example" class="table table-hover   table-striped table-bordered  text-center" dir="rtl" style="zoom:85%">
        ...
        <tbody>
<?php 
                 $invoiceList =show("SELECT * from invoice WHERE type='buy_3alaf' ORDER BY date DESC");
...
?>
       ...
       <tr>
          ...
          <td><a href="print_invoice.php?print_type=buy_3alaf&&invoice_id=<?=$invoiceDetails['id']?>"><i class="fa fa-print"></i></a></td>
          <?php if($is_admin == "1") {?>  
          <td><a href="buy_3alaf_invoice.php?invoice_id=<?=$invoiceDetails['id']?>"><i class="fa fa-edit"></i></a></td>
