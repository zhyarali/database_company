  ...
  <div class="row row-cols-1 row-cols-md-3">
    ...
    foreach ($joins as $join) {
     ...
     ?>
                ...
                <!-- delete modal -->
                <div class="modal fade" id="del<?php echo $join['id_daily'] ?>" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <input type="text" placeholder="  ناو  " name="name" value="<?=$name;?> " class="form-control col-md-10 mx-auto">
                                                        ...
                                                        <button type="submit" name="del_budget_daily"
                            ...
                            <div class="h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST">
                                        ...
                                        <label>چەن سەعات کاریکردووە</label>
                                        <div class="form-group">
                                            <input type="number" name="work_hour" class="form-control col-md-10 mx-auto">
                                        </div>

                                        <label>نرخ بۆ هەر سەعاتێکی کارکردن</label>
                                        <div class="form-group">
                                            <input type="number" name="work_hour_amount" class="form-control col-md-10 mx-auto">
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="date_end"
                                                id="inlineRadio2" value="60">
                                            <label class="form-check-label" for="inlineRadio2">٢ مانگ</label>2</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="date_end"
                                                id="inlineRadio3" value="90" >
