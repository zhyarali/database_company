...
<div class="d-flex justify-content-around mt-3 flex-wrap">
    <a  href="sale_meter_add.php"  class="btn btn-success pb-1 pt-1" >
...
<table id="example" class="table table-hover   table-striped table-bordered  text-center" dir="rtl" style="zoom:85%">
        ...
        <tbody>
<?php 
                 $invoiceList =show("SELECT * from invoice WHERE type='sale_meter' ORDER BY date DESC");
...
?>
       ...
       <tr>
          ...
          <td><a href="print_invoice.php?print_type=sale_meter&&invoice_id=<?=$invoiceDetails['id']?>"><i class="fa fa-print"></i></a></td>
          <td><a href="sale_meter_invoice.php?invoice_id=<?=$invoiceDetails['id']?>"><i class="fa fa-edit"></i></a></td>
