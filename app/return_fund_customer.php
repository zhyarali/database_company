...
<div class="container-fluid  mt-2 d-flex justify-content-around">
    <a  class="btn  btn-success s-16">گێڕانەوەی قەرزی کڕیار</a>
</div>

<div class="container-fluid  mt-2 d-flex justify-content-around">
    <form method="post" action="view_report.php">
            <input type="hidden" name="user_id" value="<?=$user_id?>">
            <button type="submit" class="btn btn-dark" name="refund_customer_info" style="border:none;" > <i class="fas fa-print"></i> پرنتکردن</button>
    </form> 
</div>
  ...
  <tr>
      ...
      <td>
        <form method="post" action="view_report.php">
            ...
            <button type="submit" name="refund_customer_info" style="border:none;background:none" > <i class="fas fa-print text-dark"></i> </button>
        </form>           
      </td>
