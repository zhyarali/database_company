...
execute("INSERT INTO `buy` (`invoice_id`,`dealer_id`,`cost_t`,`cost_co`,`num`,`type`,`cost_wasl`,`date`,`cost_fr`,`discount`,`unit`,`name_product`,`buy_type`,`status`,`note`) VALUES('$invoice_id','$dealer_id','$cost_t','$cost_co','$num','$type','$cost_wasl','$date','$cost_fr','$discount','$unit','هێلکە','helka','1','$note') ");

}

$_SESSION["edit_success"]="";
direct("buy_helka_invoice.php?invoice_id=$invoice_id");
...
<form method="post" action="buy_helka_invoice.php?invoice_id=<?=$invoice_id?>">
...
if (post('return_buy')) {
    ...
    $loc="buy_helka_invoice.php?invoice_id=".$invoice_id;
    direct($loc);
  }
